    ...
    WorkbookView.prototype.insertInCellEditor = function (name, type, autoComplete) {
        ...
        if (this.getCellEditMode()) {
            ...
            if (-1 !== this.lastFPos) {
                ...
                this.cellEditor.replaceText(this.lastFPos, this.lastFNameLength, type === c_oAscPopUpSelectorType.TableThisRow ? AscCommon.parserHelp.getColumnNameByType(AscCommon.FormulaTablePartInfo.thisRow, true) : name);
